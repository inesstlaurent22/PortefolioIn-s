...
const CONTENT = {
  ...
  en: {
    presentation: `
      ...
      <p>
        ...
        during their key growth phases.
      </p>
  ...
  zh: {
    presentation: `
      ...
      <p>
        ...
        <strong>新产品发布、
        新市场拓展，
        以及商业可见度和业绩的提升</strong>。
      </p>

      <p>
        <strong>富有好奇心且多才多艺，</strong>
        我还具备
        <strong>社群管理</strong> 和
        <strong>网页开发</strong> 能力，
        能够为项目提供
        <strong>全面、战略性和执行层面的视角</strong>。
      </p>
  ...
  en: {
    engagement: `
      <p>
        You benefit from a personalized and demanding support,
  ...
  zh: {
    engagement: `
      ...
      <p>
        <strong>✨ 你有愿景，我帮助你将其转化为可控且可持续的增长。</strong>
      </p>
    `,
    ...
    offre: `
      ...
      <div style="margin-top:40px">
        ...
        <p class="center-text">根据您的目标，合作周期为 3 至 12 个月</p>
        <p class="center-text"><strong>第 15 天</strong>：战略回顾与行动计划确认</p>
  ...
  fr: {
    offreSteps: {
      ...
      2: `
        ...
        <strong>Études de marché approfondies</strong><br>
        <strong>Analyse concurrentielle et positionnement</strong><br>
  ...
  en: {
    offreSteps: {
      ...
      2: `
        ...
        At the end of the analysis phase, you will receive:<br>
        ...
        <strong>Budget forecast and action plan</strong>
      `,
      3: `
        <strong>Deployment & Monitoring</strong><br><br>
        After validation, the mission begins with a structured and progressive support.<br><br>
  ...
  es: {
    offreSteps: {
      ...
      3: `
        ...
        <strong>Analizar resultados (KPI y rendimiento)</strong><br>
  ...
  zh: {
    offreSteps: {
      ...
      3: `
        ...
        经确认后，项目正式启动，并提供结构化、循序渐进的支持。<br><br>
        每月进行一次跟进，以便：<br>
    ...
    experience: `
      ...
      <div class="card-list">
        ...
        ${experienceCard(
          ...
          [
            "→ Design and development of an online training program for business creation",
    ...
    experience: `
      ...
      <div class="card-list">
        ...
        ${experienceCard(
          ...
          [
            "→ Diseño y desarrollo de una formación online para la creación de empresas",
            "→ Proyecto educativo para jóvenes de 10 a 17 años",
